...
tf.app.flags.DEFINE_string('test_data_path', './test_img/', '')
tf.app.flags.DEFINE_string('gpu_list', '0', '')
tf.app.flags.DEFINE_string('checkpoint_path', './east/east_icdar2015_resnet_v1_50_step100000_gpu1_batchsize-per-gpu14/', '')
            ...
            with open('./output/img_demo.txt') as f:
              ...
              with open('./output/output.txt','w') as fp:
                for line in f:
                  ...
                  cv2.imwrite('./output/word_area_img/word_area_img'+str(line_id)+'.png',roi_img)  
                  img_path = './output/word_area_img/word_area_img'+str(line_id)+'.png'
